...
//--------------------------------------------------------------------------------//
//--CONSTRUCTOR
	public function __construct($legajo=NULL, $nombre=NULL, $foto=NULL)
	{
...
//--TOSTRING	
	...
	{
	  	return $this->legajo." - ".$this->nombre." - ".$this->foto."\r\n";
	}
//--------------------------------------------------------------------------------//
	...
	public static function Modificar($obj)
	{
		...
		for($i=0; $i<count($ListaDeAlumnosLeidos); $i++){
			if($ListaDeAlumnosLeidos[$i]->legajo == $obj->legajo){//encontre el modificado, lo excluyo
				$imagenParaBorrar = trim($ListaDeAlumnosLeidos[$i]->foto);
